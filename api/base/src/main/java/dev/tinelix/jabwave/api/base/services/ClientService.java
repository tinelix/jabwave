package dev.tinelix.jabwave.api.base.services;
...
import dev.tinelix.jabwave.api.base.R;
...
public class ClientService extends IntentService {
    ...
    public void createNotification(@DrawableRes int icon, String text) {
    ...
    public int onStartCommand(@Nullable Intent intent, int flags, int startId) {
        createNotification(R.drawable.ic_notification_icon, "Text");
        startForeground();
